      ...
      messages: [
        {
          role: 'system',
          content:
            'You are a helpful assistant that answers questions based on a historical events timeline. Use the provided events to craft your answer. If the events are insufficient, say you are unsure.',
        },
        {
          role: 'user',
