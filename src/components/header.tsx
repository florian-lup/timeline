  ...
  return (
    <header className="sticky top-0 z-10 bg-background/80 backdrop-blur-sm">
      <div className="flex items-center justify-between px-3 sm:px-4 md:px-6 lg:px-8 py-2 md:py-3 lg:py-4 w-full">
        <Link
          href="/"
          className="flex items-center justify-center gap-1 md:gap-2 font-medium text-sm md:text-base lg:text-lg text-foreground/80 hover:text-foreground transition-colors"
        >
